export async function submitVote({
  ...
  // ----------------------------
  // 2. Validate ballot belongs to election
  // ----------------------------
  ...
  // ----------------------------
  // 3. Validate option belongs to ballot
  // ----------------------------
  ...
  // ----------------------------
  // 4. Prevent duplicate voting (election-level)
  // ----------------------------
  ...
  // ----------------------------
  // 5. Insert vote (ONLY normalized schema)
  // ----------------------------
